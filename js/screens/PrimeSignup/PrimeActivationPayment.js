...
class PrimeActivationPayment extends Component {
  ...
  render() {
    ...
    return (
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "position" : null} style={ { flex: 1, position: 'relative' } }>
        <Page
          headerIconLeftAsset={ Assets.iconChevronLeft }
          headerIconLeftAction={ () => goBack(null) }
          headerStyle={ Styles.primeActivationPageHeader }
          style={ Styles.primeActivationPaymentContainer }>
